...
public class GameEngineUnitTest {
    ...
    public void getTimeForMinigame() {
        ...
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.07 + 6.9) + 1600), gameEngine.getTimeForMinigame(imageButtonMinigame));

        DifficultyActivity.setDifficulty("medium");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.07 + 6.9) + 1200), gameEngine.getTimeForMinigame(imageButtonMinigame));

        DifficultyActivity.setDifficulty("hard");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.07 + 6.9) + 800), gameEngine.getTimeForMinigame(imageButtonMinigame));


        DifficultyActivity.setDifficulty("easy");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.075 + 7) + 2000), gameEngine.getTimeForMinigame(coverLightSensorMiniGame));

        DifficultyActivity.setDifficulty("medium");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.075 + 7) + 1500), gameEngine.getTimeForMinigame(coverLightSensorMiniGame));

        DifficultyActivity.setDifficulty("hard");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.075 + 7) + 1000), gameEngine.getTimeForMinigame(coverLightSensorMiniGame));


        DifficultyActivity.setDifficulty("easy");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.1 + 8) + 2000), gameEngine.getTimeForMinigame(drawingMinigame));

        DifficultyActivity.setDifficulty("medium");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.1 + 8) + 1500), gameEngine.getTimeForMinigame(drawingMinigame));

        DifficultyActivity.setDifficulty("hard");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.1 + 8) + 1000), gameEngine.getTimeForMinigame(drawingMinigame));


        DifficultyActivity.setDifficulty("easy");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.07 + 7.5) + 1800), gameEngine.getTimeForMinigame(rightButtonCombination));

        DifficultyActivity.setDifficulty("medium");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.07 + 7.5) + 1300), gameEngine.getTimeForMinigame(rightButtonCombination));

        DifficultyActivity.setDifficulty("hard");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.07 + 7.5) + 800), gameEngine.getTimeForMinigame(rightButtonCombination));


        DifficultyActivity.setDifficulty("easy");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.06 + 7.6) + 1400), gameEngine.getTimeForMinigame(shakePhoneMinigame));

        DifficultyActivity.setDifficulty("medium");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.06 + 7.6) + 1000), gameEngine.getTimeForMinigame(shakePhoneMinigame));

        DifficultyActivity.setDifficulty("hard");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.06 + 7.6) + 600), gameEngine.getTimeForMinigame(shakePhoneMinigame));


        DifficultyActivity.setDifficulty("easy");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.08 + 7) + 3000), gameEngine.getTimeForMinigame(sliderMinigame));

        DifficultyActivity.setDifficulty("medium");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.08 + 7) + 2000), gameEngine.getTimeForMinigame(sliderMinigame));

        DifficultyActivity.setDifficulty("hard");
        assertEquals((long) (Math.exp(-gameEngine.getScore() * 0.08 + 7) + 1000), gameEngine.getTimeForMinigame(sliderMinigame));
    }
